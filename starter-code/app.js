...
app.get('/colors', (request, response, next) => {

response.locals.listOfColors = colors;
response.render('colors.ejs');

});

app.get('/beige', (request, response, next) => {

response.locals.listOfColors = colors;
response.render('beige.ejs');

});

app.get('/grayscale', (request, response, next) => {
...
app.get('/pink', (request, response, next) => {

response.locals.listOfColors = colors;
response.render('pink.ejs');
...
response.locals.randomColor = colors[randomIndex];
